...
export default function TermsPage() {
  ...
  return (
    <section className="relative max-w-6xl mx-auto px-4 py-20">
      ...
      {/* header */}
      <div
        className={`mb-8 transition-all duration-700 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-3"}`}
      >
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">
              By using Query Survey App, you agree to the following terms and
              conditions.
            </p>
          </div>
        </div>
      ...
      {/* top actions */}
      <div
        className={`flex items-center justify-between gap-4 mb-8 ${mounted ? "opacity-100" : "opacity-0"} transition-opacity duration-700`}
      >
      ...
      {/* summary badges */}
      <div
        className={`grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10 ${mounted ? "opacity-100" : "opacity-0"} transition-opacity duration-700`}
      >
        ...
        <div className="bg-white p-4 rounded-2xl shadow flex items-start gap-3 border-l-4 border-green-500">
          ...
          <div>
            ...
            <div className="font-medium">
              Location & selfie verification required
            </div>
          </div>
        </div>
      ...
      {/* Terms Content */}
      <div
        className={`max-w-none space-y-8 ${mounted ? "opacity-100" : "opacity-0"} transition-opacity duration-700`}
      >
        ...
        <section className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 text-xs mt-1">
                ✓
              </div>
              <div>
                ...
                <div className="text-gray-600">
                  Data entered by you must be verified by you
                </div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-600">
                  Full risk lies with the user for providing incorrect
                  information
                </div>
              </div>
            </div>
        ...
        <section className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center text-green-600 text-xs mt-1">
                📍
              </div>
              <div>
                <div className="font-semibold text-gray-900">
                ...
                <div className="text-gray-600">
                  Providing correct location is mandatory
                </div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-600">
                  Providing correct selfie is mandatory
                </div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-600">
                  Fraud detection system automatically prevents misuse
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-600">
                  Data will remain secure even in offline mode
                </div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-600">
                  Data sync is mandatory when internet connection is available
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-red-100 rounded-full flex items-center justify-center text-red-600 text-xs mt-1">
                🚫
              </div>
              <div>
                <div className="font-semibold text-gray-900">
                ...
                <div className="text-gray-600">
                  You cannot use the app for any illegal activities
                </div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-600">
                  App usage is restricted to legitimate survey and data
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-600">
                  Your account can be suspended if misuse is detected
                </div>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-gray-600">
                  We continuously monitor for compliance with these terms
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="mt-12 flex flex-col sm:flex-row items-center justify-between gap-4 bg-gray-50 rounded-2xl p-6">
        <div className="text-sm text-gray-700">
          Need clarification on any terms? Contact our legal team for
          assistance.
        </div>
      ...
      <div className="mt-8 text-xs text-gray-400 text-center">
        Last updated: {new Date().toLocaleDateString()}. By using Query Survey
